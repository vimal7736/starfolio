    ...
    <div className="b text-stone-300 py-16 px-4 lg:px-20">
      ...
      <div className="max-w-3xl mx-auto p-8 bg-transparent text-gray-600 rounded-lg shadow-2xl mb-10">
        ...
        <div className="space-y-4 text-center">
          ...
          <p><span className="font-bold">Phone:</span> +91-7736173889</p>
          <p><span className="font-bold">Address:</span> Love shore, Naithiyattu Paramba, Post-Puthiyara, Kozhikode, Kerala, India </p>
          <p><span className="font-bold">Website:</span> www.vimalsuresh.com</p>
        </div>
      </div>
